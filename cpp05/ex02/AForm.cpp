...
AForm::GradeTooHighException::GradeTooHighException(int grade) throw() : _grade(grade)
{
	std::stringstream ss;
	ss << _grade;
	_message = "AForm Exception: Grade Too High. Grade: " + ss.str();
}
...
AForm::GradeTooLowException::GradeTooLowException(int grade) throw() : _grade(grade)
{
	std::stringstream ss;
	ss << _grade;
	_message = "AForm Exception: Grade Too Low. Grade: " + ss.str();
}
